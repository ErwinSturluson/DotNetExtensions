...
using DotNetExtensions.Authorization.OAuth20.Server.ClientSecretReaders.AuthorizationHeaderBasic;
using DotNetExtensions.Authorization.OAuth20.Server.ClientSecretReaders.RequestBodyClientCredentials;
using DotNetExtensions.Authorization.OAuth20.Server.ClientSecretReaders.TlsCertificate;
using DotNetExtensions.Authorization.OAuth20.Server.Default.ClientSecrets;
...
public static class IClientSecretServiceCollectionExtensions
{
    ...
    public static IServiceCollection SetOAuth20ClientSecre1tTypesFromConfiguration(this IServiceCollection services)
    {
        ...
        if (options.ClientSecrets?.ClientSecretTypes is not null && options.ClientSecrets.ClientSecretTypes.Any())
        {
