...
namespace DotNetExtensions.Authorization.OAuth20.Server.Generators.Contracts.Enumerations
{
    [Generator]
    ...
    public class ClientProfileSourceGenerator : ISourceGenerator
    {
...
";
        ...
        {
            context.AddSource("ClientProfile.g.cs", SourceText.From(_code, Encoding.UTF8));
        }
